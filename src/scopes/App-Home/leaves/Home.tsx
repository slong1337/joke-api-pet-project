...
export function Home() {
    return (
        <div className="mx-6 my-4">
            ...
            <p className=" font-medium max-w-2xl ">Здесь вы всегда найдете свежие, остроумные и забавные шутки на любой вкус.
            ...
            <p className=" font-medium max-w-2xl ">Очень просто! Введите слово или фразу, и наш сайт подберет шутки, связанные с вашим запросом. Пример: «шутки о программистах»,
            ...
            <div >         
                <div className=" flex items-center my-2 ">
                    ...
                    <p className="font-normal text-xl px-2">выбирайте, что вам ближе: от юмора о профессиях до мемов о животных.</p>
                </div>
                <div className=" flex items-center my-2">
                    <h3 className=" font-semibold text-2xl ">Генератор случайных шуток - </h3>
                    <p className="font-normal text-xl px-2">если не знаете, что выбрать, не переживайте, мы сами подберем вам что-то смешное!</p>
                </div>
            </div>
